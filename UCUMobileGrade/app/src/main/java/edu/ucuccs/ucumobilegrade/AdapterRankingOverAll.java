 ...
 */
public class AdapterRankingOverAll extends RecyclerView.Adapter<AdapterRankingOverAll.MyViewHolder> {
    private ArrayList<RankingGetOverall> dataSet;
    ...
    public AdapterRankingOverAll(ArrayList<RankingGetOverall> data){
        this.dataSet=data;
    }
