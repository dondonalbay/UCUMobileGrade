 ...
 */
public class SheetAdapterPost extends RecyclerView.Adapter<SheetAdapterPost.MyViewHolder>{
    ...
    public SheetAdapterPost(ArrayList<GetSheetMenu> data){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(NewsActivity.mySheetClickListener);
