 ...
 */
public class SheetAdapterRank extends RecyclerView.Adapter<SheetAdapterRank.MyViewHolder>{
    ...
    public SheetAdapterRank(ArrayList<GetSheetMenu> data){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(RankActivity.mySheetClickListener);
