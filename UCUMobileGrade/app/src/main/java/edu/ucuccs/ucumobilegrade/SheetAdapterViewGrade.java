 ...
 */
public class SheetAdapterViewGrade extends RecyclerView.Adapter<SheetAdapterViewGrade.MyViewHolder>{
    ...
    public SheetAdapterViewGrade(ArrayList<GetSheetMenu> data){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(ViewGrade.mySheetClickListener);
